...
diana_ross.recently_heard.create(album: the_great_bear)
diana_ross.recently_heard.create(album: paw_paw_tree)
diana_ross.recently_heard.create(album: aldebaran)
